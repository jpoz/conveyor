...
class hubStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.Heartbeat = channel.unary_unary('/wire.hub/Heartbeat', request_serializer=jobs__pb2.Checkin.SerializeToString, response_deserializer=jobs__pb2.Empty.FromString)
        ...
        self.Fail = channel.unary_unary('/wire.hub/Fail', request_serializer=jobs__pb2.FailRequest.SerializeToString, response_deserializer=jobs__pb2.Empty.FromString)
...
class hub(object):
    ...
    def Heartbeat(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/wire.hub/Heartbeat', jobs__pb2.Checkin.SerializeToString, jobs__pb2.Empty.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Fail(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/wire.hub/Fail', jobs__pb2.FailRequest.SerializeToString, jobs__pb2.Empty.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)